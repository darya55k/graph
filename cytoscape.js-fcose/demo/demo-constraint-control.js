...
let defaultStylesheet = [
  ...
  {
    selector: 'node.rudn_fac_2',
    style: {
      'shape': 'square',
      'background-color': '#4866D0',

    }
  },
  {
    selector: 'node.rudn_fac_3',
    style: {
      'shape': 'square',
      'background-color': '#A260CB',
  ...
  {
    selector: 'node.rudn_fac_1_sub:selected',
    style: {
      'background-color': '#33ff00',
  ...
  {
    selector: 'node.rudn_fac_2_sub:selected',
    style: {
      'background-color': '#33ff00',
  ...
  {
    selector: 'node.rudn_fac_3_sub',
    style: {
      'shape': 'square',
      'background-color': '#BA88D8',

    }
  },
  {
    selector: 'node.rudn_fac_3_sub:selected',
    style: {
      'background-color': '#33ff00',
...
let cy = window.cy = cytoscape({
  ...
  elements: {
    nodes: [
      ...
      //{ data: { id: 'n3', parent: 'n8', label: 'Предмет 1', type: "disciplin" } },
      //{ data: { id: 'n14', parent: 'rudn_parent', label: 'Предмет 1', type: "disciplin" } },
      //{ data: { id: 'n17', parent: 'n10', label: 'Предмет 1', type: "disciplin" } },
      //{ data: { id: 'n16', parent: 'n11', label: 'Предмет 1', type: "disciplin" } },
      { data: { id: 'rudn_fac_1', parent: 'rudn_parent', label: 'Экономический факультет' }, classes: ['rudn_fac_1'] },
      { data: { id: 'rudn_fac_2', parent: 'rudn_parent', label: 'Институт иностранных языков' }, classes: ['rudn_fac_1', 'rudn_fac_2'] },
      {
        data: {
          id: 'rudn_fac_3', parent: 'rudn_parent', label: 'Институт мировой\nэкономикии бизнеса'
        }, classes: ['rudn_fac_1', 'rudn_fac_3']
      },
      // { data: { id: 'n35', parent: 'n9', label: 'kykt' } },
      { data: { id: 'rudn_fac_1_sub_1', label: 'Банковское дело' }, classes: ['rudn_fac_1_sub'] },
      { data: { id: 'rudn_fac_1_sub_2', label: 'Практический аудит' }, classes: ['rudn_fac_1_sub'] },
      //{ data: { id: 'rudn_fac_1_sub_3', parent: 'rudn_parent', label: 'Налоги и налогообложение' } },

      //{ data: { id: 'rudn_fac_2_sub_1', parent: 'rudn_parent', label: 'Теория международных отношений' } },
      { data: { id: 'rudn_fac_2_sub_1', label: 'Лексикология' }, classes: ['rudn_fac_2_sub', 'rudn_fac_1_sub'] },
      { data: { id: 'rudn_fac_2_sub_2', label: 'Теоретическая грамматика' }, classes: ['rudn_fac_2_sub', 'rudn_fac_1_sub'] },


      { data: { id: 'rudn_fac_3_sub_1', label: 'Бережливое производство' }, classes: ['rudn_fac_3_sub', 'rudn_fac_1_sub'] },
      { data: { id: 'rudn_fac_3_sub_2', label: 'Международный менеджмент' }, classes: ['rudn_fac_3_sub', 'rudn_fac_1_sub'] },
      //{ data: { id: 'rudn_fac_3_sub_3', parent: 'rudn_parent', label: '' } },
      //{ data: { id: 'n6', parent: 'rudn_parent', label: 'Дисциплины' }, classes: ['fixed'] },
      //{ data: { id: 'n7', parent: 'rudn_parent', label: 'Предмет 3' } },
      /*{ data: { id: 'n12', parent: 'n9', label: 'Предмет 2' } },
      { data: { id: 'n13', parent: 'n9', label: 'Предмет 3' } }, */
      //{ data: { id: 'n8', label: 'ИТМО' } },
      { data: { id: 'rudn_parent', label: 'РУДН' }, classes: ['title'] },
      //{ data: { id: 'n10', label: 'РАНХИГС' } },
      //{ data: { id: 'n11', label: 'бла бла' } },
      /* { data: { id: 'f1' }, classes: ['fixed'] },
      { data: { id: 'f2' }, classes: ['fixed'] },
      { data: { id: 'f3', parent: 'n9' }, classes: ['fixed'] }, */
    ],

    edges: [
      //{ data: { source: 'rudn_fac_1', target: 'n6' } },
      //{ data: { source: 'rudn_fac_2', target: 'n6' } },
      //{ data: { source: 'rudn_fac_3', target: 'n6' } },
      //{ data: { source: 'n35', target: 'n6' } },
      { data: { source: 'rudn_fac_1_sub_1', target: 'rudn_fac_1' } },
      { data: { source: 'rudn_fac_1_sub_2', target: 'rudn_fac_1' } },
      //{ data: { source: 'rudn_fac_1_sub_3', target: 'rudn_fac_1' } },

      { data: { source: 'rudn_fac_2_sub_1', target: 'rudn_fac_2' } },
      { data: { source: 'rudn_fac_2_sub_2', target: 'rudn_fac_2' } },
      //{ data: { source: 'rudn_fac_2_sub_3', target: 'rudn_fac_2' } },

      { data: { source: 'rudn_fac_3_sub_1', target: 'rudn_fac_3' } },
      { data: { source: 'rudn_fac_3_sub_2', target: 'rudn_fac_3' } },
      //{ data: { source: 'rudn_fac_3_sub_3', target: 'rudn_fac_3' } },
